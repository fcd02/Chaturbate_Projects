...
**Current release:** v0.4.3 — Git Bridge Bootstrap Recovery Hotfix
**Updated:** 2026-09-20
**Service port:** `127.0.0.1:8793` by default
**SQLite schema:** v2 (unchanged)
**Upgrade base:** v0.4.2; patch is source/docs/tests/tooling only and must preserve active config + state.
